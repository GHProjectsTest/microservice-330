...
public class Mensa extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "330", version = "0.0.0",
          description = "",
          termsOfService = "",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/GHProjectsTest/microservice-330/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  @ApiResponses(value = {
       ...
       @ApiResponse(code = HttpURLConnection.HTTP_OK, message = "Dish Rating")
  })
